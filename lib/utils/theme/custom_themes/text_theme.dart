...
// This class defines the Theme of our Text in ours themes (Light,Dark)
class TFCTextTheme {
  TFCTextTheme._();

  // Light Text Theme (On a light screen put the text with a black color, certain size and bold)
  ...
  // Dark Text Theme (On a Dark screen put the text with a white color, certain size and a variant of bold(w600))
